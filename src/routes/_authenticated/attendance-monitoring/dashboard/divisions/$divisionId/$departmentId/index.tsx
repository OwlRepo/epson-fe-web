...
function RouteComponent() {
  const params = useParams({
    from: "/_authenticated/attendance-monitoring/dashboard/divisions/$divisionId/$departmentId/",
  });
  const {
    data,
    isLoading,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {isConnected && !isLoading ? (
          data
            ...
            .map((section) => (
              <Link
                to={`/attendance-monitoring/dashboard/divisions/$divisionId/$departmentId/$sectionId`}
