...
function RouteComponent() {
  ...
  const { data: liveData, isLoading: isLiveDataLoading, isConnected: isLiveDataConnected, countData } = useOverviewCountData({
    room: "AMS",
    dataType: "live",
  })
  ...
  return (
    <div className="space-y-8">
      ...
      <CardSection headerLeft={<CardHeaderLeft title={<div className="flex items-center space-x-2"><EpsonFlame /><b className="text-[20px] text-primary">Live Data</b></div>} subtitle="" />} >
        ...
        {
          isLiveDataConnected && !isLiveDataLoading ? <div className='flex'>
            <LiveDataTable
              ...
              data={liveData.map(employeeData => {
