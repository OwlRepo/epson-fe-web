      ...
      <div className="grid grid-cols-5 gap-8 mt-4 items-start">
        ...
        <div className="col-span-3 grid grid-cols-3 gap-4 border-r border-gray-300 pr-8">
          <div className="col-span-3">
            ...
            <p className="text-xl text-gray-600">Employee Division</p>
          </div>
          ...
          {employeeDivisions.map((division) => (
            ...
            >
              ...
              <div className="flex justify-between mt-auto">
                <div className="flex flex-col text-[#219800]">
        ...
        {/* 2nd row */}
        <div className="col-span-2 grid grid-cols-2 gap-4 border-r border-gray-300 pr-8">
